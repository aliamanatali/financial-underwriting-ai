            ...
            try:
                ...
                for idx, row in df_data.iterrows():
                    ...
                    current_sheet_roll.append(RentRollItem(
                        ...
                        unit_type=str(self._get_val(row, ["Unit Type", "Type", "Floor Plan", "Occupancy Type","Bed/Bath"], "")),
                        unit_size=parsed_size_val,
                        tenant_name=tenant_name,
                        current_rent=self._parse_float(self._get_val(row, ["Rent Amount", "Current Rent", "Rent", "Total Rent", "$/Month", "Rate", "2024 Rent", "Total Monthly", "Monthly Rent"], 0.0)),
