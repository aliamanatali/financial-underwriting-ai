...
export default function AuditTrailWidget({
  ...
  const getSourceIcon = (source: string) => {
    if (source.toLowerCase().includes("rent roll")) return "📊";
    if (source.toLowerCase().includes("om") || source.toLowerCase().includes("offering")) return "📋";
    if (source.toLowerCase().includes("p&l") || source.toLowerCase().includes("financial")) return "📈";
    if (source.toLowerCase().includes("calculated")) return "🧮";
    if (source.toLowerCase().includes("gating") || source.toLowerCase().includes("viability")) return "✓";
    return "📌";
  };
