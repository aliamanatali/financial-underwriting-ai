      ...
      <main className="flex-1 flex flex-col relative items-center justify-center p-6 z-10">
        <div className="w-full max-w-md">
            ...
            <div className="flex flex-col bg-white w-full h-full rounded-[15px] p-8 md:p-10 border border-[#E2E8F0]">
              ...
              <form className="flex flex-col gap-4" onSubmit={handleLogin}>
                <div className="space-y-1.5">
                  <label htmlFor="username" className="text-xs font-medium text-[#475569] ml-0.5">Username</label>
                  <div className="relative group">
                    ...
                    <input
                      type="text" id="username" name="username" value={email} onChange={(e) => setEmail(e.target.value)}
              ...
              <button
                type="button"
                onClick={() => { login(email, password); router.push("/home"); }}
          ...
          <p className="text-sm text-[#64748B] text-center mt-6">
            ...
            <Link href="/signup" className="text-[#F97316] hover:underline font-semibold">Sign up</Link>
          </p>
