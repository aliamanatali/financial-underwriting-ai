        ...
        <table className="min-w-full divide-y divide-slate-200">
          ...
          <tbody className="bg-white divide-y divide-slate-200">
            {localExpenses.map((expense) => {
              ...
              const isEdited = !!originalItem?.user_correction;
              return (
              <tr key={expense.id} className={`${isEdited ? 'bg-orange-50' : isVerified ? 'bg-emerald-50/30' : 'hover:bg-slate-50'} transition-colors duration-150`}>
